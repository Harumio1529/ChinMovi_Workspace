...
class MS5837(object):
    ...
    def init(self):
        ...
        self.i2c.write_byte(self._MS5837_ADDR, self._MS5837_RESET)
        ...
        for i in range(7):
            c = self.i2c.read_word_data(self._MS5837_ADDR, self._MS5837_PROM_READ + 2*i)
    ...
    def read(self, oversampling=OSR_8192):
        ...
        self.i2c.write_byte(self._MS5837_ADDR, self._MS5837_CONVERT_D1_256 + 2*oversampling)
        ...
        d = self.i2c.read_i2c_block_data(self._MS5837_ADDR, self._MS5837_ADC_READ, 3)
        self._D1 = d[0] << 16 | d[1] << 8 | d[2]
        
        # Request D2 conversion (temperature)
        self.i2c.write_byte(self._MS5837_ADDR, self._MS5837_CONVERT_D2_256 + 2*oversampling)
