...
class StatusAnalyzer:
    def __init__(self):
        ...
        self.STCONTROLLER_List=["PREPARING","MANUAL_CONTROL","ATTITUDE_CONTROL","AUTO_CONTROL","FULLAUTO_PREPARING","FULLAUTO_READY","SEARCH","DETERMIN","RANDOM_WALK","APPROACH","ATTACK","ATTACK_BEAST","TARGET_CHANGE"]
